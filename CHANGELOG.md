...
- Changing regex responsible for UnicodeAlpha validation - @lukaszjedrasik ([#5340](https://github.com/vuestorefront/vue-storefront/issues/5340))
...
- Decompress items in `api-search-query` adapter - @cewald (#4630)
